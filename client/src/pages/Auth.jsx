      ...
      <div className="hidden lg:flex w-1/2 bg-blue-600 relative overflow-hidden flex-col justify-between p-12 text-white">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <motion.div 
            ...
            className="absolute top-[20%] right-[10%] lg:right-[15%] bg-white/85 backdrop-blur-xl border border-white/50 p-4 rounded-3xl hidden lg:flex items-center gap-4 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] w-64"
          >
          ...
          <motion.div 
            ...
            className="absolute top-[44%] left-[10%] lg:left-[15%] bg-white/85 backdrop-blur-xl border border-white/50 p-4 rounded-3xl hidden lg:flex items-center gap-4 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] w-64 scale-95"
          >
          ...
          <motion.div 
            ...
            className="absolute top-[28%] left-[20%] lg:left-[25%] bg-white/85 backdrop-blur-xl border border-white/50 p-4 rounded-3xl hidden lg:flex items-center gap-4 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] w-64 scale-90"
          >
          ...
          <motion.div 
            ...
            className="absolute top-[52%] right-[10%] lg:right-[15%] bg-white/85 backdrop-blur-xl border border-white/50 p-4 rounded-3xl hidden lg:flex items-center gap-4 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] w-64 scale-90"
          >
          ...
          <motion.div 
            ...
            className="absolute top-[36%] right-[20%] lg:right-[25%] bg-white/85 backdrop-blur-xl border border-white/50 p-4 rounded-3xl hidden lg:flex items-center gap-4 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] w-64 scale-90"
          >
          ...
          <motion.div 
            ...
            className="absolute top-[12%] left-[10%] lg:left-[15%] bg-white/85 backdrop-blur-xl border border-white/50 p-4 rounded-3xl hidden lg:flex items-center gap-4 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] w-64 scale-75"
          >
