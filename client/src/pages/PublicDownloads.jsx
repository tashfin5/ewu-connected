    ...
    <div className="h-full w-full overflow-y-auto bg-slate-50 dark:bg-[#0a0a0a] text-slate-900 dark:text-zinc-100 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20">
          {/* Windows Download */}
          <motion.a
            href="https://github.com/tashfin5/ewu-connected/releases/download/v1.0.6/EWU.ConnectED.Setup.exe"
            target="_blank"
          ...
          {/* Android Download */}
          <motion.a
            href="https://github.com/tashfin5/ewu-connected/releases/download/v1.0.6/EWU.ConnectED.apk"
            target="_blank"
            rel="noopener noreferrer"
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
